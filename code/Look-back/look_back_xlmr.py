...
# %%
def final_allignment_pre_processing(token,true_label,pred_label,underscore_pos):
    my_list = token
    ...
    return my_list,true_list,pred_list
    


# %%
hi_token,hi_position = underscore_position(hindi_token)
final_hindi_token,final_hindi_true_label,final_hindi_pred_label = final_allignment_pre_processing(hi_token,hindi_true_label,hindi_predicted_label,hi_position)

ang_token,ang_position = underscore_position(angika_token)
final_angika_token,final_angika_true_label,final_angika_pred_label = final_allignment_pre_processing(ang_token,angika_true_label,angika_predicted_label,ang_position)

mag_token,mag_position = underscore_position(magahi_token)
final_magahi_token,final_magahi_true_label,final_magahi_pred_label = final_allignment_pre_processing(mag_token,magahi_true_label,magahi_predicted_label,mag_position)

bho_token,bho_position = underscore_position(bhojpuri_token)
final_bhojpuri_token,final_bhojpuri_true_label,final_bhojpuri_pred_label = final_allignment_pre_processing(bho_token,bhojpuri_true_label,bhojpuri_predicted_label,bho_position)
...
# %%
swapped_predicted_look_back_hindi = look_back(final_hindi_token,final_hindi_true_label,final_hindi_pred_label)
swapped_predicted_look_back_angika = look_back(final_angika_token,final_angika_true_label,final_angika_pred_label)
swapped_predicted_look_back_magahi = look_back(final_magahi_token,final_magahi_true_label,final_magahi_pred_label)
swapped_predicted_look_back_bhojpuri = look_back(final_bhojpuri_token,final_bhojpuri_true_label,final_bhojpuri_pred_label)


# %%
from sklearn.metrics import classification_report
print("Hindi Look Back Prediction")
print(classification_report(final_hindi_true_label,swapped_predicted_look_back_hindi))


# %%
print("Angika Look Back Prediction")
print(classification_report(final_angika_true_label,swapped_predicted_look_back_angika))


# %%
print("Magahi Look Back Prediction")
print(classification_report(final_magahi_true_label,swapped_predicted_look_back_magahi))


# %%
print("Bhojpuri Lookback score Result")
print(classification_report(final_bhojpuri_true_label,swapped_predicted_look_back_bhojpuri))

print("Ye Rembert look back hai")